    ...
    <section
        ...
        <div
            ...
            <!-- 
                ...
                'origin-bottom' is the pivot point. The rotation is driven 
                by the bearing prop via CSS transform.
            -->
            <div class="absolute bottom-1/2 left-1/2 w-[2px] h-32 origin-bottom transition-transform duration-300 ease-out"
        ...
        <div class="mt-10 flex justify-between gap-4 relative z-20">
            ...
            <div class="flex-1 bg-slate-950/80 p-3 border-l-2 border-emerald-500 rounded-r-lg text-right shadow-inner">
                ...
                <span class="text-2xl font-black glow">{{ confidence }}%</span>
            </div>
        </div>
    </section>
</template>
 ...
 * Forces all digits to have the same width.
 */
.tabular-nums {
